...
name = input("Введи своє ім'я: ") # Змінна name (текст)
age = int(input("А ще введи свій вік: ")) # age
print(f"Привіт, {name}! Через рік тобі буде {age + 1} років") # f потрібен, щоб в дужках можна було писати не лише текст, але й вказувати змінні"""
